...
import {amazonhelpSectiontabs} from "./helpHelper";
let ebayBanner = require("../../../../../assets/welcome_screen.jpg");

class Amazonhelp extends Component {

    constructor(props) {
        super(props);
        this.state = {
            tabs : {
                tabList : amazonhelpSectiontabs,
                selectedTab : 0
            },
            faq: [
    ...
    renderTabStructure(tab){
        ...
        switch (tab){
            ...
            case 1:
                let videosList = [];
                videos.forEach((obj) => {
                    videosList = [ ...videosList, mediaCardPolaris(obj.title, obj.description, videoThumbnailPolaris(ebayBanner, { content: 'Learn more', onAction : () => {} }))]
                });
                return videosList;
