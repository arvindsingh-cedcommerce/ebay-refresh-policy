import {
  ...
  const ProductViewPolarisNewBCKP = (props) => {
    ...
    const prepareDataForSave = () => {
      ...
      for (const key in mainProduct) {
        ...
        if (["length", "width", "height", "unit"].includes(key)) {
      ...
      <PageHeader
        ...
        title={
          <Stack alignment="center">
            <Thumbnail
              source={mainProduct?.["mainImage"] ? mainProduct?.["mainImage"] : NoProductImage}
              size="large"
              alt="image"
            />
  ...
  export default ProductViewPolarisNewBCKP;
