...
class TitleTemplateComponent extends Component {
    ...
    renderTemplateBody(key){
        ...
        temparr.push(
            ...
            //     <Card.Section>
            <AntCard title={cardHeading[key]}  key={"feildsettings"+[key]}>
                    <FormLayout>
                        {
    ...
    render() {
        ...
        return (
            // <Card title={"Title template"} key={'TitleTemplateComponent'}
            //       primaryFooterAction={{content: 'Save', loading:this.props.loader, onAction: this.saveFormdata.bind(this)}}
            // >
            <AntCard title={"Title template"} key={'TitleTemplateComponent'} actions={[<AntButton type='primary' loading={this.props.loader} onClick={this.saveFormdata.bind(this)}>Save</AntButton>]}>
                {/* <Card.Section>
                    {
                ...
                <Alert description={<p><b>Title template </b>helps you map desired Shopify attributes to Title, sub title & description attribute of eBay. You can even pass combination of Shopify attributes and custom values to the aforementioned eBay attributes.</p>} type='info' showIcon />
                {/* <Card.Section> */}
                <Divider />
...
export default withRouter(TitleTemplateComponent);