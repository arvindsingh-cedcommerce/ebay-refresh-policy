...
const ProductSettingsNew = () => {
              ...
              if (temp[key]["shopId"] == id) {
                ...
                for (const field in temp[key]["fields"]) {
                  ...
                  if (
                    ...
                    temp[key]["fields"][field]["match_from_ebay"] =
                      data.marketplace.ebay.shop[id]["data"][
                        "product_settings"
                      ]["app_to_ebay"][field]["match_from_ebay"];
                  }
                }
              }
            }
  ...
  return flag ? (
    <Card sectioned>
      <SkeletonPage fullWidth={true} title="Shopify To App">
        <Card.Section>
...
export default ProductSettingsNew;
