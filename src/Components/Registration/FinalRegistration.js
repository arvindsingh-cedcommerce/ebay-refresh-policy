...
import { order_settings, product_settings } from "./StaticData/importSettings";
...
export const FinalRegistration = (props) => {
                  ...
                  >
                    <Card.Section>
                      ...
                      <Stack vertical={true} spacing={"none"}>
                        ...
                        />
                        <Checkbox
                          label="Do not use similar shopify app/sales-channel for eBay."
                          ...
                          helpText={
                            <Stack vertical spacing="extraTight">
                              <>
                                ...
                                sales-channel for similar type of feature which
                                you are going to use in this app. i.e.{" "}
